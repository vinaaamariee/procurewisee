    ...
    <div className="pr-purpose-section my-2.5 border border-slate-900 p-3 bg-white font-serif text-xs space-y-1.5 break-inside-avoid" style={{pageBreakInside: 'avoid'}}>
      ...
      {isReadOnly ? (
        ...
        <textarea
          ...
          className="w-full p-2 border border-slate-300 rounded font-serif text-xs text-slate-900 bg-[var(--secondary-dim)]/50 focus:outline-none focus:ring-1 focus:ring-[#7B1E1E] resize-y"
        />
      )}
    </div>
  );
