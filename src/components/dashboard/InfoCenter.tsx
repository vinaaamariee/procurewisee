    ...
    >
      ...
      <div className="space-y-6 p-6 font-sans">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3
                className="mt-2 text-4xl font-extrabold font-sans"
        ...
        <Link
          ...
          className="flex items-center justify-center gap-2 rounded-xl py-3 text-xs font-bold text-white transition hover:opacity-90 shadow-sm hover:shadow"
          style={{
