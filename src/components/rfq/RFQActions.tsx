      ...
      <div className="flex items-center gap-2 sm:gap-3 bg-slate-900/90 text-white px-4 py-3 rounded-2xl shadow-2xl backdrop-blur-md border border-slate-700/60 max-w-[95vw] overflow-x-auto">
        ...
        {onPublish && (
          <button
            ...
            disabled={isPending}
            onClick={onPublish}
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-[#7B1E1E] text-xs font-bold text-white hover:bg-[#7B1E1E] transition shadow-md disabled:opacity-50"
          >
