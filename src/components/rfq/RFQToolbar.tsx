      ...
      <div className="flex items-center gap-2 sm:gap-3 bg-slate-900/90 text-white px-4 py-3 rounded-2xl shadow-2xl backdrop-blur-md border border-slate-700/60 max-w-[95vw] overflow-x-auto">
        ...
        {setIsReadOnly && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-700 bg-slate-800/80 text-xs font-semibold text-amber-300 hover:bg-slate-700 transition cursor-pointer"
          >
            {isReadOnly ? (
              <>
