      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {features.map((feature) => {
          ...
          return (
            <div
              key={feature.title}
              className="group bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 p-5 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex items-start gap-4"
            >
              <div
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-xs text-[#6B7280] dark:text-gray-400 leading-relaxed">
                  {feature.description}
                </p>
              </div>
            </div>
