        ...
        <div className="card bg-gradient-to-r from-base-200/60 via-base-100 to-base-200/60 p-6 sm:p-10 rounded-3xl border border-base-200 shadow-md">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 text-left">
              <div className="badge badge-outline border-[#D4AF37] text-[var(--secondary-strong)] font-bold uppercase tracking-wider text-xs py-2 px-3">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <Link
                  href="/catalog"
                  className="btn btn-primary btn-md rounded-xl bg-[#800000] hover:bg-[#800000] text-white border-none font-bold shadow-md px-6"
                >
                ...
                <Link
                  href="/track"
                  className="btn btn-outline btn-md rounded-xl border-[#800000] text-[#800000] hover:bg-[#800000] hover:text-white font-bold px-6"
                >
              ...
              <div className="card bg-base-100 p-5 rounded-2xl border border-base-200 shadow-sm space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-xl bg-base-200/50 text-xs">
                    <div className="flex items-center gap-2">
                      <PackageCheck className="h-4 w-4 text-[var(--secondary-strong)]" />
                      <span className="font-bold text-base-content">Paper Products & Stationery</span>
                    </div>
                    <span className="font-bold text-[#800000]">A4 80gsm Paper</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-base-200/50 text-xs">
                    ...
                    <span className="font-bold text-[var(--secondary-strong)]">LaserJet Cartridges</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-base-200/50 text-xs">
                    ...
                    <span className="font-bold text-[#800000]">Standard Items</span>
                  </div>
                </div>
              </div>
            </div>
