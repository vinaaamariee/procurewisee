                    ...
                    <div>
                      ...
                      <div className="mt-3 grid grid-cols-1 sm:grid-cols-5 gap-3 max-w-2xl">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="h-1.5 w-full bg-muted-foreground/10 rounded-full overflow-hidden">
                            <div className="h-full rounded-full" style={{ width: `${s.individualScores.reliabilityScore}%`, background: 'rgba(128, 0, 0, 0.55)' }} />
                          </div>
                        </div>
                        {/* Compliance */}
                        <div className="space-y-1">
                          ...
                          <div className="h-1.5 w-full bg-muted-foreground/10 rounded-full overflow-hidden">
                            <div className="h-full rounded-full" style={{ width: `${s.individualScores.complianceScore}%`, background: 'rgba(212, 175, 55, 0.75)' }} />
                          </div>
                        </div>
                        {/* Historical */}
                        <div className="space-y-1">
                          ...
                          <div className="h-1.5 w-full bg-muted-foreground/10 rounded-full overflow-hidden">
                            <div className="h-full rounded-full" style={{ width: `${s.individualScores.historicalPerformanceScore}%`, background: 'rgba(128, 0, 0, 0.35)' }} />
                          </div>
                        </div>
                      </div>
                    </div>
