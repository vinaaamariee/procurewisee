  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full pl-4 pr-11 py-3 border border-gray-300 dark:border-gray-700 rounded-xl outline-none focus:border-[#D4AF37] bg-[#FAFAFA] dark:bg-gray-900 text-xs transition text-gray-900 dark:text-white"
          />
      ...
      <button
        ...
        className="w-full bg-[#800000] hover:bg-[#800000] disabled:bg-gray-400 text-white py-3 rounded-xl font-bold text-xs transition uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer shadow-md"
      >
        {loading ? (
          <>
