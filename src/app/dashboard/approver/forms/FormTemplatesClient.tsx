              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: active ? "rgba(128, 0, 0, 0.04)" : "#fff",
                      ...
                      <tr key={idx} style={{ borderBottom: "1px solid rgba(0,0,0,0.04)" }}>
                        ...
                        <td style={{ padding: "0.75rem", textAlign: "center" }}>
                          <button
                            ...
                            disabled={isProcessing}
                            style={{ padding: "0.25rem 0.5rem", borderRadius: "0.25rem", border: "none", background: "rgba(128, 0, 0, 0.1)", color: "var(--accent)", fontWeight: 700, cursor: "pointer" }}
                          >
                            Delete
                          </button>
                        </td>
