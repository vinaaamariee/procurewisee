      ...
      <div style={{ padding: '1.5rem' }}>
        {message && (
          <div style={{
            ...
            background: message.type === 'success' ? 'var(--secondary-dim)' : 'var(--accent-glass)',
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
            ...
            <select name="role" required style={{ padding: '0.5rem 0.75rem', borderRadius: 8, background: 'var(--bg-deep)', border: '1px solid var(--border)', color: 'var(--text-primary)', fontSize: '0.85rem', outline: 'none', appearance: 'none' }}>
              <option value="Procurement Officer" style={{ background: 'var(--bg-dark)', color: 'var(--text-primary)' }}>Procurement Staff</option>
