...
export default function PPMPDashboardClient({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
      ...
      {/* Notifications */}
      {message && (
        <div style={{ padding: "1rem", borderRadius: "0.75rem", background: "rgba(128, 0, 0, 0.1)", border: "1px solid rgba(128, 0, 0, 0.2)", color: 'var(--secondary-strong)', fontSize: "0.85rem", fontWeight: 600 }}>
          {message}
        </div>
      )}
      {errorMsg && (
        <div style={{ padding: "1rem", borderRadius: "0.75rem", background: "rgba(128, 0, 0, 0.1)", border: "1px solid rgba(128, 0, 0, 0.2)", color: "var(--accent)", fontSize: "0.85rem", fontWeight: 600 }}>
          {errorMsg}
        </div>
      )}
                    ...
                    <tr key={ppmp.id} style={{ borderBottom: "1px solid var(--border)", verticalAlign: "middle" }}>
                      ...
                      <td style={{ padding: "1.25rem 1.5rem", textAlign: "center" }}>
                        <div style={{ display: "inline-flex", alignItems: "center", gap: "0.4rem", fontSize: "0.7rem", fontWeight: 700 }}>
                          ...
                          <span style={{ color: "var(--text-muted)" }}>→</span>
                          <span style={{ color: timelineStep >= 4 ? "#800000" : "var(--text-muted)" }}>
                        ...
                        {hasPr && prRecord && (
                          <div style={{ marginTop: "0.5rem", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.25rem" }}>
                            <span style={{ fontSize: "0.65rem", color: "var(--text-muted)" }}>
                              PR Generated: <strong style={{ color: "#800000" }}>{prRecord.prNumber}</strong>
                            </span>
                            <Link
